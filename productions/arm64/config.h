...
#define FFMPEG_CONFIGURATION "--enable-cross-compile --arch=arm --target-os=darwin --cc='clang -arch arm64' --as='/usr/local/bin/gas-preprocessor.pl -arch aarch64 -- clang -arch arm64' --cpu=armv8 --enable-pic --prefix=productions/arm64 --sysroot=/Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS16.1.sdk --disable-ffmpeg --disable-ffprobe"
#define FFMPEG_LICENSE "LGPL version 2.1 or later"
#define CONFIG_THIS_YEAR 2023
#define FFMPEG_DATADIR "productions/arm64/share/ffmpeg"
#define AVCONV_DATADIR "productions/arm64/share/ffmpeg"
