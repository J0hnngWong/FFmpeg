...
#define FFMPEG_CONFIGURATION "--enable-cross-compile --arch=arm --target-os=darwin --cc='gcc -arch arm64' --as='/usr/local/bin/gas-preprocessor.pl -arch aarch64 -- gcc -arch arm64' --cpu=armv8 --enable-pic --prefix=productions/arm64 --sysroot=/Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS16.1.sdk"
